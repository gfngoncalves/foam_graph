...
def test_plot_2d():
    ...
    np.testing.assert_equal(lines, [[[-1.,  0.],[ 0.,  0.]]])

    points = ax.collections[0]
    np.testing.assert_equal(points.get_offsets().data, [[-1.,  0.],[ 0.,  0.]])
...
def test_plot_3d():
    ...
    points = fig.data[1]
    np.testing.assert_equal(points.x, [-1.,  0.])
    np.testing.assert_equal(points.y, [0.,  0.])
    np.testing.assert_equal(points.z, [0.,  1.])